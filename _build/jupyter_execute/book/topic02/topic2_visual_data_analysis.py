...
# # <center>Topic 2. Visual data analysis in Python </center> <a class="tocSkip">
# ## <center>Part 1. Visualization: from Simple Distributions to Dimensionality Reduction</center> <a class="tocSkip">
