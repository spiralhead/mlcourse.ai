...
# # <center>Assignment #2 (demo). Solution</center><a class="tocSkip">
# ## <center>Analyzing cardiovascular disease data </center><a class="tocSkip">
#     
#     
...
# 
# #  Part 1. Preliminary data analysis <a class="tocSkip">
# 
